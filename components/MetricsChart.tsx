    ...
    <div className="w-full h-80">
      <ResponsiveContainer width="100%" height="100%">
        <AreaChart data={MOCK_TRAINING_HISTORY}>
          ...
          <Tooltip 
            contentStyle={{ backgroundColor: '#0A192F', border: '1px solid #1E293B', borderRadius: '8px', boxShadow: '0 4px 12px rgba(0,0,0,0.5)' }}
    ...
    <div className="w-full h-80">
      <ResponsiveContainer width="100%" height="100%">
        <ScatterChart margin={{ top: 20, right: 20, bottom: 20, left: 20 }}>
          ...
          <XAxis type="number" dataKey="x" name="Step" stroke="#64748b" unit="" fontSize={10} />
          <YAxis type="number" dataKey="y" name="Confidence" stroke="#64748b" unit="%" fontSize={10} />
          <ZAxis type="number" dataKey="z" range={[60, 400]} />
          <Tooltip cursor={{ strokeDasharray: '3 3' }} contentStyle={{ backgroundColor: '#0A192F', border: '1px solid #1E293B' }} />
    ...
    <div className="w-full h-80">
      <ResponsiveContainer width="100%" height="100%">
        <ComposedChart data={data}>
          ...
          <Tooltip contentStyle={{ backgroundColor: '#0A192F', border: '1px solid #1E293B' }} />
          <Legend />
