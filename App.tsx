  ...
  <div className="fixed inset-0 z-[100] bg-black flex flex-col items-center justify-center p-8 animate-in fade-in duration-300">
    <div className="w-full max-md text-center px-4">
      <div className="mb-8 relative flex justify-center">
        ...
        <i className="fa-solid fa-satellite-dish text-[#F97316] text-2xl md:text-3xl"></i>
      </div>
      ...
      <div className="w-full h-[2px] bg-slate-900 overflow-hidden rounded-full">
          <div className="h-full bg-[#F97316] animate-[progress_2s_linear_infinite]"></div>
      </div>
    </div>
  </div>
);
    ...
    const reportHtml = `
      ...
      <head>
        ...
        <style>
          ...
          .value { font-size: 32px; font-weight: 800; color: #F1F5F9; }
          .description { margin-top: 40px; background: #0A192F; padding: 30px; border-radius: 10px; line-height: 1.6; font-style: italic; border-left: 5px solid #F97316; }
                 ...
                 <div className="space-y-12">
                   ...
                   <div className="flex flex-col items-center gap-8">
                     ...
                     <div className="w-full max-w-4xl glass-panel p-6 rounded-2xl bg-black/80 border border-white/5 overflow-hidden font-mono text-[11px]">
                        <div className="flex justify-between items-center mb-4 pb-2 border-b border-white/10 uppercase tracking-widest text-[#F97316]">Tactical Console</div>
               ...
               {activeMenu === 'View Results' && result && result.visuals && (
                 <div className="space-y-10">
                   <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                     ...
                     <div className="glass-panel p-10 rounded-[2rem] border-l-4 border-navy-700"><p className="text-[11px] font-bold text-white/30 uppercase mb-3 tracking-widest">IoU Fidelity</p><p className="text-5xl font-cinzel text-white font-black">{result.iou.toFixed(3)}</p></div>
